...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/home/mjemieli/TESTING/chipcraft-toolchain/outputroot/i686-w64-mingw32/mips-cc-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
