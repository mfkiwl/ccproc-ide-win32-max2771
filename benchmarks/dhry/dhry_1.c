  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  error_flag |= 1<<11;
  if (strncmp(Next_Ptr_Glob->variant.var_1.Str_Comp, "DHRYSTONE PROGRAM, SOME STRING",30))
  error_flag |= 1<<12;
  if (Int_1_Loc != 5)
  error_flag |= 1<<13;
  if (Int_2_Loc != 13)
  ...
  if (Enum_Loc != 1)
  error_flag |= 1<<16;
  if (strncmp(Str_1_Loc, "DHRYSTONE PROGRAM, 1'ST STRING",30))
  error_flag |= 1<<17;
  if (strncmp(Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING",30))
  error_flag |= 1<<18;
